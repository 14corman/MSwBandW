...
# script for running a python program
python cifar10_main.py --data-dir=/nfsscratch/cifar-10-data  --job-dir=${PWD}/outputV24 --num-gpus=1 --train-steps=10000
